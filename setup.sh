...
install_apt() {
    ...
    # Do not install gdb and gdbserver from apt, they are too old
    ...
    sudo apt-get install -y git python3-dev python3-venv python3-pip python3-setuptools libglib2.0-dev libc6-dbg
